...
1. Upload these files to a new GitHub repository.
2. Go to Netlify.com and "Import from Git".
3. Netlify will detect the settings automatically (thanks to netlify.toml).
4. Click Deploy.

## Note on Google Login
After deploying, add your new URL to the "Authorized JavaScript Origins" in your Google Cloud Console.
`;
